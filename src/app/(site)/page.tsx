      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-8 mt-6 md:mt-12">
        <div className="flex-1 py-6 border border-gray-200 rounded-sm flex">
          ...
          <div className="flex-1 pl-8">
            ...
            <div className="text-gray-400">Para todo o país</div>
          </div>
        </div>
        <div className="flex-1 py-6 border border-gray-200 rounded-sm flex">
          <div className="w-32 border-r border-gray-200 flex justify-center items-center">
          ...
          <div className="flex-1 pl-8">
            ...
            <div className="text-gray-400">Ofertas imbatíveis</div>
          </div>
        </div>
        <div className="flex-1 py-6 border border-gray-200 rounded-sm flex">
          <div className="w-32 border-r border-gray-200 flex justify-center items-center">
          ...
          <div className="flex-1 pl-8">
            ...
            <div className="text-gray-400">No período de 30 dias</div>
          </div>
        </div>
      </div>
    </div>
